declare module "iexpire" {
  ...
  export declare type Events = "error" | "subtract" | "delete" | "end";
   ...
   * @constructor
   */
  export function MongoDbExpirer(
    connection: Model<any, any, any, any, any>,
    options?: any
  ): MongoDbExpirer;
  export class MongoDbExpirer {
    /**
     *
     * @param {Model} connection
     * @param {*} options
     ...
     * @constructor
     */
    constructor(connection: Model<any, any, any, any, any>, options?: Options);
     ...
     * @return {EventEmitter} Current instance of EventEmitter for chaining.
     */
    on(event: Events, listener: Function): EventEmitter;
    ...
    /**
     * Sets the current value to sync against when executing listeners. If a
     * listeners return value matches the one set here then it will be removed
     * after execution. This value defaults to true.
     *
     * @param {any} value The new value to sync for when executing listeners.
     * @return {EventEmitter} Current instance of EventEmitter for chaining.
     */
